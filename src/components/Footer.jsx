    ...
    <footer className="footer-section">
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-info-item mt-4">
              <MapPin size={18} />
              <p>Contagem, MG<br/>Atendemos toda a região</p>
            </div>
          </div>

          {/* Coluna 2: Horário e Contato */}
          <div className="footer-col">
            <h4 className="footer-title">HORÁRIO & CONTATO</h4>
            <div className="footer-info-item">
              <Clock size={18} />
              <div>
                <strong>Horário de Funcionamento:</strong>
                <p>Trabalhamos sob encomenda</p>
                <p>Retirada a combinar</p>
              </div>
            </div>
            <div className="footer-social mt-3">
              <a href="https://www.instagram.com/paodecasa5?igsh=ZXNjNTM1OWl5NzZp" target="_blank" rel="noopener noreferrer" className="social-icon-btn instagram" aria-label="Instagram">
              ...
              <a href="https://api.whatsapp.com/send?phone=5531973623218&text=Ol%C3%A1!%20Gostaria%20de%20fazer%20uma%20encomenda%20dos%20p%C3%A3es%20da%20P%C3%A3o%20de%20Casa." target="_blank" rel="noopener noreferrer" className="social-icon-btn whatsapp" aria-label="WhatsApp">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Pão de Casa. Todos os direitos reservados.</p>
          <div className="footer-links">
            <button className="legal-btn" onClick={() => onOpenLegal('privacy')}>Política de Privacidade</button>
            <span className="separator">•</span>
            <button className="legal-btn" onClick={() => onOpenLegal('terms')}>Termos de Uso</button>
          </div>
        </div>
      </div>
    </footer>
